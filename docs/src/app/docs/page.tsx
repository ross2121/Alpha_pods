  ...
  return (
    <div>
      ...
      <p className="mt-2 text-sm text-slate-400">
        Welcome to AlphaPods - a decentralized governance platform for managing
        DeFi strategies, treasury decisions, and protocol upgrades. Get started
        with the AlphaPods Telegram bot in three steps.
      </p>
      ...
      <h2 className="mt-8 text-base font-semibold">
        Step 2: See DAOs and subscribe
      </h2>
      <p className="mt-2 text-sm text-slate-300">
        Send <code>/realms</code> to see all DAOs (realms) the bot knows about.
        You&apos;ll see each DAO&apos;s name, network, and whether you&apos;re
        following it.
      </p>
      <p className="mt-2 text-sm text-slate-300">
      ...
      <p className="mt-4 text-sm text-slate-400">
        For full command list and details, see the sidebar: <strong>Guides</strong>{" "}
        and <strong>Reference -&gt; Telegram Command Reference</strong>.
      </p>
    </div>
  );
}
